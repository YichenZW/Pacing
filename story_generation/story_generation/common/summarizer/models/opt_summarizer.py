    ...
    def __call__(self, 
        ...
        for text_idx, text in enumerate(texts):
            ...
            if context_length > self.args.max_context_length - max_tokens:
                logging.warning('opt context length' + ' ' + str(context_length) + ' ' + 'exceeded artificial context length limit' + ' ' + str(self.args.max_context_length - max_tokens))
                print('TOO LONG CONTEXT: ' + text)
                print('CONTEXT LENGTH:' + str(context_length))
                raise Exception('opt context length exceeded artificial context length limit')
